...
<!-- 	 </div>	 -->
     <div class="searchInfoDiv">
          <form id="cardSearchForm" action="" method="post">
           <table>
              <tr>
                <td><div class="firstFont">卡片序列：</div></td>
                <td><div><input name="cardSn" class="form-control"/></div></td>
                <td><div  class="leftFont">卡片编号：</div></td>
                <td><div><input name="cardNo" class="form-control"/></div></td>
                <td><div class="leftFont">卡片类型：</div></td>
                <td><div>
            ...
            <table>  
              <tr>  
<!--                 <td><div class="firstFont"><input type="checkbox" name="nearEndCard"/>&nbsp;&nbsp;快到期卡片</div></td> -->
<!--                 <td><div class="leftFont"><input type="checkbox" name="nearEndCard"/>&nbsp;&nbsp;已到期卡片</div></td> -->
                <td><div class="firstFont">卡片状态：</div></td>
                <td><div>
