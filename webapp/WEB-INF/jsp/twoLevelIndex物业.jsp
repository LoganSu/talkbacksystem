...
<%-- 	        </r:role> --%>
	        ...
	        <r:role auth="客户关系管理">   
	           <div class="panel panel-primary">
	                   <div class="panel-heading" data-toggle="collapse" data-parent="#accordion2" href="#collapsEleven">
	                       <span class="Item-icon-wuye1 Item-icon glyphicon" aria-hidden="true"></span>
	                       <a class="accordion-toggle">客户关系管理</a>
                         <i class="icon"></i>
	                   </div>
	                   <div id="collapsEleven" class="panel-collapse collapse" style="height: 0px;">
	                       <div class="panel-body">
		                       <ul class="nav nav-pills nav-stacked">
		                           <r:role auth="客户信息">
                                     <!-- module table json对象， modulePath 是在js/table里面定义的 search.jsp路径对象 -->
                                     <li><a class="li_a" href="javascript:void(0)" rel="${path}/mc/dweller/dwellerListshowPage.do?module=dwellerTable&modulePath=/dweller">客户信息</a></li>
                                   </r:role>
		                           <r:role auth="关于小区">
			                       ...
			                       <r:role auth="客户投诉">
		                             <li><a class="li_a" href="javascript:void(0)" rel="${path}/mc/repairs/repairsshowPage.do?module=repairsTable&modulePath=/repairs&orderNature=2">客户投诉</a></li>
		                           </r:role>
		                           <r:role auth="客户报修">
		                             <li><a class="li_a" href="javascript:void(0)" rel="${path}/mc/repairs/repairsshowPage.do?module=repairsTable&modulePath=/repairs&orderNature=1">客户报修</a></li>
		                           </r:role>
		                           <r:role auth="收费管理">
		                             <li><a class="rongbang_pay" href="javascript:void(0)" rel="http://test.masget.com:8234/masgetweb/redirect/subsys.do?session=mscwmzutkb8dc546uyy477u0goxvzPp&page=rent">收费管理</a></li>
		                           </r:role>
	           ...
	           <div class="panel panel-primary">
	                   <div class="panel-heading" data-toggle="collapse" data-parent="#accordion2" href="#collapseTen">
	                       <span class="Item-icon-wuye1 Item-icon glyphicon" aria-hidden="true"></span>
	                       <a class="accordion-toggle">物业管理</a>
                         <i class="icon"></i>
	                   </div>
