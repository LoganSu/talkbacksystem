...
<body>
	...
	<div class="functionBut">
         <ul class="list-unstyled list-inline">
                ...
                <r:role auth="角色管理/修改">
                      <li><button class="btn btn-warning btn-sm saveOrUpdateBtn" rel="${path}/mc/role/toSaveOrUpdate.do" saveUrl="${path}/mc/role/saveOrUpdate.do">修改</button></li>
	            </r:role>
	            <!--delete类 公共删除  -->
	            <r:role auth="角色管理/删除">
    ...
    <div class="searchInfoDiv">
          <form id="roleSearchForm" action="" method="post">
           <table>
              <tr>
...
<!--                 <td><div><input name="realName" class="form-control"/></div></td> -->
                ...
                <td><div class="leftFont"><button class="btn btn-info btn-sm search" rel="${path}/mc/role/showList.do">查询</button></div></td>
              </tr>
           </table>
        </form>
       </div>
