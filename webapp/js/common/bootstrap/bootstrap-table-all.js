...
!function ($) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = [that.options.cardView ?
                        ...
                        '<input' +
                            ...
                            sprintf(' id="%s"', item[that.options.idField]) +
    ...
    BootstrapTable.prototype.fitHeader = function () {
        ...
        if ((navigator.userAgent.indexOf('MSIE') >= 0)&& (navigator.userAgent.indexOf('Opera') < 0)){
    	      $headerHeight = -this.$header.height()-16;
    		}
        this.$el.css('margin-top', $headerHeight);
    ...
    $.fn.bootstrapTable = function (option) {
        ...
        this.each(function () {
            ...
            //自己定义tale宽度
            if(options.width&& parseInt(options.width)){
            	$(this).parent().css("width",options.width+"px");
            }
