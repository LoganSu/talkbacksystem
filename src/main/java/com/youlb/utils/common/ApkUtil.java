...
//	                	if("res/layout/settings.xml".equals(zipEntry.getName())){
//	                		 try {  
...
//	    public static X509Certificate readSignatureBlock(InputStream in) throws IOException, GeneralSecurityException {
	    ...
	    public static void main(String[] args) {  
	        String[] str = null;  
	        try {
//	        	File file = new File("E:\\Users\\workspace64bit\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\talkbackSystem\\appDir\\phone\\20160405175125.apk");
	        	File file = new File("e:\\IMSDroid.apk");
	            str = ApkUtil.unZip(file); 
	        } catch (Exception e) {  
	            // TODO Auto-generated catch block  
	            e.printStackTrace();  
	        }  
